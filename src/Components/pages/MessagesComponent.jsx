...
// import addmissionpic from '.././pic/addmission.jpg'
  ...
  return (
    ...
    <div className="messages-container">
      <div className="header">
        <img src={addmissionpic} alt="Message Header" className="header-image" />
      </div>
      <div className="message-section">
        ...
        <div className="message-content">
          ...
          <div className="message-text">
            <p>
              To set the child in the right direction in order to build a strong and firm foundation, Uma Ram Shankar Singh Inter College Moglahan Kunwar Campierganj Gorakhpur, an Hindi medium institution, is here to offer inevitable opportunities and resources. It works best with strong interests and direction.
            </p>
            <p>
      ...
      <div className="message-section">
        ...
        <div className="message-content">
          ...
          <div className="message-text">
            ...
            <p>
              It is a matter of pride and immense pleasure that destiny has given me the opportunity to join URS Inter college family as its head. I take this opportunity to welcome all teachers, students, parents, staffs, guardians for choosing this school and being a part of it.
            </p>
            <p>
              Through the Uma Ram Shankar Singh Inter College Moglahan Kunwar Campierganj Gorakhpur curriculum, our academic standards improve every year. Being a pure English Medium School in this kind of homely environment, the school is designed to be both accessible and challenging for all students, irrespective of their ability. Modern technologies like Smart Boards, Projectors, Science Laboratory, Computer Lab are part of the curriculum.
            </p>
            <p>
